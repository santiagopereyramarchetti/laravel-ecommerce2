...
<script setup>
    ...
    const form =  reactive({
        ...
        address: usePage().props.auth.user?.billing_detail?.address,
        city: usePage().props.auth.user?.billing_detail?.city,
        state: usePage().props.auth.user?.billing_detail?.state,
        zip_code: usePage().props.auth.user?.billing_detail?.zip_code,
        name_on_card: '',
    })
    const errors = ref([])
